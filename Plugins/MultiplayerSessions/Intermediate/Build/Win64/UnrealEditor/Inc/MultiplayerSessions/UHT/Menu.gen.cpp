...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMenu_MenuSetup_Statics::Function_MetaDataParams[] = {
		...
		{ "ModuleRelativePath", "Public/Menu.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "+ Menu Setup, create the menu widget and set input to UI\n+ Default values were defined in case none specific value is used." },
#endif
	};
#endif
...
#if !UE_BUILD_SHIPPING
		{ "Comment", "/*\n\x09* Callbacks for the custom Delegates on MultiplayerSessionSubSystem\n\x09*/" },
#endif
		{ "ModuleRelativePath", "Public/Menu.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "* Callbacks for the custom Delegates on MultiplayerSessionSubSystem" },
#endif
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMenu_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMenu_MenuSetup, "MenuSetup" }, // 3124426519
		{ &Z_Construct_UFunction_UMenu_OnCreateSession, "OnCreateSession" }, // 307813597
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMenu_Statics::NewProp_HostButton_MetaData[] = {
		{ "BindWidget", "" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Buttons Binding and functions\n" },
#endif
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/Menu.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Buttons Binding and functions" },
#endif
	};
#endif
	...
	UMenu::~UMenu() {}
	struct Z_CompiledInDeferFile_FID_Projetos_WeDefeatNations_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projetos_WeDefeatNations_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMenu, UMenu::StaticClass, TEXT("UMenu"), &Z_Registration_Info_UClass_UMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMenu), 2596834442U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projetos_WeDefeatNations_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_3311577261(TEXT("/Script/MultiplayerSessions"),
		Z_CompiledInDeferFile_FID_Projetos_WeDefeatNations_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projetos_WeDefeatNations_Plugins_MultiplayerSessions_Source_MultiplayerSessions_Public_Menu_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
